...
class external_t : public api::isolate_t, public std::enable_shared_from_this<external_t> {
public:
    external_t(context_t& context,
...
private:
    // This pimpl is here to prevent calling some "init" method to safely call shared_from_this to
    // pass to timer.
